...
// Route::group(['prefix' => 'hotel', 'as' => 'hotel.'], function () {
    ...
    Route::get('/review/visible',[App\Http\Controllers\Hotel\ReviewController::class,'visible'])->name('review.visible');
    Route::get('/review/hide',[App\Http\Controllers\Hotel\ReviewController::class,'hide'])->name('review.hide');
